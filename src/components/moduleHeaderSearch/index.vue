    ...
    <div class="module-panel">
        <div class="search-panel">
            ...
            <div class="item-search">
                <h2>随机数据</h2>
                <div class="item-body">
                <el-radio v-for="(item,index) in searchData.publicModuleData.moduleData[0].settingData.randomData" v-bind:key="index" v-model="searchData.publicModuleData.moduleData[0].settingData.isRandom" v-bind:label="item.type" border>{{item.name}}</el-radio>
                </div>
            </div>
            <div class="item-search" v-if="searchData.publicModuleData.moduleData[0].settingData.isRandom=='0'">
                ...
                <div class="item-body">
                <div class="inline-body">
                    <div class="inline-content"><el-input v-model="searchData.publicModuleData.moduleData[0].settingData.moduleGUID" placeholder="模块的唯一标识类名"></el-input></div>
