    ...
    <div class="module-panel">
        <div class="search-panel">
            ...
            <div class="item-search">
                <h2>随机数据</h2>
                <div class="item-body">
                <el-radio v-for="(item,index) in searchData.longTailWordData.moduleData[0].settingData.randomData" v-bind:key="index" v-model="searchData.longTailWordData.moduleData[0].settingData.isRandom" v-bind:label="item.type" border>{{item.name}}</el-radio>
                </div>
            </div>
