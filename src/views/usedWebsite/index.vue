        ...
        <div class="website-wrapper" v-if="!isPreview">
            <div class="ltw-abs-search">
                <div class="ltw-search-panel">
                    <div class="ltw-item-search ltw-guid-panel"><el-input placeholder="请输入站点ID" v-model="ID" clearable></el-input></div>
            ...
            <div class="result-page" v-if="resultData.length>0" v-loading="loading">
                <div class="website-list">
                    <div class="item-website" v-for="(item,index) in resultData" v-bind:key="index">
                        <div class="item-wrap" v-bind:class="item.isDelete =='1'?'is-delete':''">
                            <div class="item-content"><p><span>websiteID<br />{{item.ID}}<br /><strong v-if="item.isDelete =='1'">激活时间：{{item.freeDate}}</strong></span></p></div>
                            <div class="item-button">
                                ...
                                <span v-if="item.isDelete =='1'"><i class="iconfont icon-time"></i>激活中...</span>
